const WEBSITE_KNOWLEDGE_SECTIONS = [
  ...
  },
  {
    ...
    answer:
      'AI Helpper website ka built-in assistant hai. Yeh Gemini ya OpenAI powered text chat me guide karta hai, website ke features samjhata hai, important user notes yaad rakh sakta hai, aur OpenAI key configured hone par live voice mode me mic ke through natural conversation ka support deta hai.',
    details: [
      ...
      'Assistant widget recent chat ko local history me save kar sakta hai taaki conversation dubara dikh sake.',
      'Agar user important personal ya preference note bataye to assistant use saved memory ke roop me future replies me use kar sakta hai.',
